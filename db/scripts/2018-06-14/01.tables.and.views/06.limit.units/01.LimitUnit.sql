...
CREATE TABLE [dbo].[LimitUnit](
	...
	[LimitDesc] [nvarchar](100) NOT NULL,
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The English Description for LimitUnit.' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'LimitUnit', @level2type=N'COLUMN',@level2name=N'LimitDesc'
GO
