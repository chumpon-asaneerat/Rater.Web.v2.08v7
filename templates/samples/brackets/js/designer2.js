...
function ShowSlideTemplate() {
    console.log('Show Slide Template.');
    var slideTemplates = document.getElementById('slideTemplates');
    var toolBox = document.getElementById('toolBox');
    slideTemplates.parentElement.style['transform'] = 'translate(1px)';
    toolBox.parentElement.style['transform'] = 'translate(-99999px)';
};

function ShowToolbox() {
    var slideTemplates = document.getElementById('slideTemplates');
    var toolBox = document.getElementById('toolBox');
    slideTemplates.parentElement.style['transform'] = 'translate(-99999px)';
    toolBox.parentElement.style['transform'] = 'translate(1px)';
};
